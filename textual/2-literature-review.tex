% Literature Review
% Patterns in general form = not too big - 2 pages
% Studies that suggest pattern - expand : works that suggest refacoring - automate/assist decision-making
% empirical study usage pattern
% Usage of design pattens
% design pattern detection
% Design pattern suggestions
% Machine Learning Design pattern suggestions or Design pattern recognition
%Talking about the most modern tools and what are the academic papers about it
% How to evaluate trust in AI-assisted decision making? A survey of empirical methodologies \cite{Vereschak2021}
% Studies on software design / architecture decision making
% Software Design Decisions
% A methodology to develop AI software in an organization \cite{Rago2018}

% \section{Design Decision-Making}
...
\subsubsection{UML-Based Approach}\label{subsec:uml-approach}
...
\subsubsection{Question-Answer-Based Approach}\label{subsec:question-answer-approach}
...
\subsubsection{CBR-Based Approach}\label{subsec:cbr-approach}
...
\subsubsection{Anti-Patterns-Based Approach }\label{subsec:anti-pattern-approach}
...
\subsubsection{Text-Classification-Based Approach}\label{subsec:text-classification-approach}
...
On the other hand, unsupervised models almost underperform supervised models due to the need to find regular patterns ~\cite{Li2017}. Thus, in practical applications, the semi-supervised method, a composite of supervised and unsupervised learning, alleviates the need for supervision to a minimum. As this method explores a small number of labeled and many unlabeled samples, researchers in various fields have been using semi-supervised algorithms as an alternative to traditional machine learning methods that indicate significant performance compared to labeled data ~\cite{Gorriz2017, Li2017, Seliya2007, Sigdel2014}.
...
\subsubsection{Information-Retrieval-Based Approach}\label{subsec:retrieval-approach}
...
\subsubsection{Ontology-Based Approach}\label{subsec:ontology-approach}
...
However, the designer can only use the concepts defined in the ontology.~\textcite{Bou2018} preprocessed the constructed ontology and the design problem to create feature vectors. They suggested design patterns based on the similarity between design patterns and design problem vectors.~\textcite{Blomqvist2008} created an ontology for the design problem and tried to find the similarity between the constructed ontology from patterns and problems.
 ...
 \subsubsection{Others Approaches}\label{subsec:others-approach}
...
\subsubsection{Combination of Approaches}\label{subsec:combination-approach}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|p{.60\linewidth}|r|p{.01\linewidth}|} \hline
        ...
        Ontology and IR & \cite{Bou2018, Laosen2020} \\
        \rowcolor{gray!19} Ontology and CBR & \cite{Blomqvist2008} \\ 
        Ontology and QA & \cite{Pavlivc2014} \\
        \rowcolor{gray!19} CBR and IR & \cite{Muangon2009adaptation,Muangon2009analysis} \\ 
        CBR and QA & \cite{Qureshi2017} \\
        \rowcolor{gray!19} CBR, QA and IR & \cite{Sanyawong2014,Bouassida2015, Celikkan2019} \\ \hline 
    \end{tabular}
    \objectsource{\objectsourceauthor}
\end{table}
  
\subsubsection{Trade-offs between the Design Patterns Selection Approaches} \label{subsec:trade-offs-approaches}
