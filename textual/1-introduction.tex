...
This collaboration between AI tools and developers is relatively new, so it is crucial to understand its effectiveness and possible side effects, the nature of interactions, how these tools will be incorporated into the software development cycle, and the perceived benefits of particular interest. Furthermore, assessing whether using such devices leads to improvements or accelerates the software development process is necessary. Thus, detailed assessments of how developers and companies use AI tools in their software development cycles are essential to incorporate and optimize these new technologies successfully.

\section{Objective}\label{sec:objective} 
\label{section objective}
\begin{quote}
\textbf{The goal of this dissertation is:} 
\end{quote}
\begin{quote}
\textbf{Evaluate the potential of using AI-assisted tools to make design decisions in software projects to understand their strengths and limitations to guide their application in this context.}
\end{quote}

\section{Research Questions}\label{sec:research-questions}
\begin{quote}
\textbf{What is the potential of AI-assisted tools for design decision-making in software projects?}

\begin{itemize}
    \item  \textbf{\textit{RQ\textsubscript{1}}} -  What are the characteristics and types of AI-assisted tools for design decision-making in software projects?
    \item \textbf{\textit{RQ\textsubscript{2}}} - What are the strengths and limitations of AI-assisted tools for design decision-making in software projects?
    \item \textbf{\textit{RQ\textsubscript{3}}} -  How can AI-assisted tools be applied and integrated with different phases and contexts of software development?
    \item \textbf{\textit{RQ\textsubscript{4}}} - How do software engineers perceive and use AI-assisted tools for design decision-making in software projects?
\end{itemize}
...
% Inicio Figura1 ---------------------------
\begin{figure}[ht]
\caption{Overview of the methodology adopted in this work.}
\centering
\label{fig-methodology}
\includegraphics[width=0.96 \textwidth]{figures/methodology.png}
\objectsource{\objectsourceauthor}
\end{figure}
% Fim Figura1 ---------------------------
...
\item Chapter~\ref{ch:literature-review} - Literature Review: This chapter provides valuable information about an overview of Artificial Intelligence, Prompt Engineering for Generative, Few-Shot Learning, and various approaches to selecting design patterns, revealing a gap in the absence of generative AIs to discover such design patterns.
 ...
 \item Chapter~\ref{ch:current-state} - Current State: This chapter provides information on the current work status and outlines the next steps for the planning and execution of the work.
