...
\begin{itemize}
    ...
    \item \textbf{\textit{RQ\textsubscript{2}: What approaches can be applied in the usage of generative AI tools to support decision-making in software architecture?}} -- To answer that question, our work based on existing prompt patterns, and used design science to explore other alternatives. As a result, a new set of prompt patterns and a prompt sequence was proposed.
